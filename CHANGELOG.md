...
## 29.0.1-r1 / 28.0.6-r1 / 27.1.9-r1 (2024/06/01)

* Fix malformed nginx configuration (#161)

## 29.0.1-r0 / 28.0.6-r0 / 27.1.9-r0 (2024/06/01)

* Nextcloud 29.0.1, 28.0.6, 27.1.9 (#157)
* Add `BODY_TIMEOUT` env var (#160)
